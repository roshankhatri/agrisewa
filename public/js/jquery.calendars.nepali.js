	...
	$.extend(NepaliCalendar.prototype, {
		...
		regionalOptions: { // Localisations
			'': {
				name: 'Nepali',
				epochs: ['BBS', 'ABS'],
				monthNames: ['बैशाख', 'जेठ', 'असार', 'श्रावण', 'भाद्र', 'आश्विन',
				'कार्तिक', 'मंसिर', 'पौष', 'माघ', 'फाल्गुन', 'चैत्र'],
				monthNamesShort: ['बै', 'जे', 'अ', 'श्र', 'भा', 'अश', 'कर', 'मांग', 'पौ', 'मा', 'फा', 'चैत'],
				dayNames: ['आईतबार', 'सोमबार', 'मंगलबार', 'बुधबार', 'बिहीबार', 'शुक्रवार', 'शनिबार'],
				dayNamesShort: ['आई', 'सो', 'मंगल', 'बुध', 'बिही', 'शुक्र', 'शनि'],
				dayNamesMin: ['आई', 'सो', 'मंगल', 'बुध', 'बिही', 'शुक्र', 'शनि'],
