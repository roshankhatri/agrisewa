 	...
 	alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevText: '&lt;महिना',
				prevStatus: 'अघिल्लो महिना हेर्नुहोस',
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'Show the previous year',
				nextText: 'महिना&gt;',
				nextStatus: 'पछिल्लो महिना हेर्नुहोस',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Show the next year',
				currentText: 'Current',
				currentStatus: 'Show the current month',
				todayText: 'आज',
				todayStatus: 'यो महिना हेर्नुहोस',
				clearText: 'हटाऊ',
				clearStatus: 'मिति हताउनुहोस',
				closeText: 'बन्द',
				closeStatus: 'मिति नह्टाई बन्द गर्नुहोस',
